...
public class ForecastRealmRetrofitRepository implements ForecastRepository {
    ...
    private final Converter<Response<ServerForecast>, Forecast> forecastConverter;
    private final Realm realm;

    public ForecastRealmRetrofitRepository(Resources res, ForecastService forecastService, Converter<Response<ServerForecast>, Forecast> forecastConverter, Realm realm) {
        this.res = res;
